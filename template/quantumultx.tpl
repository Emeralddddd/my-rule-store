...
socks5={{ relayNode.server }}:{{ relayNode.port }}, username={{ relayNode.username }}, password={{ relayNode.password }}, fast-open=false, udp-relay=true, tag={{ relayNode.name }}
{% endfor %}
...
{{ remoteSnippets.providerSubscription.main('DIRECT') | quantumultx}}
