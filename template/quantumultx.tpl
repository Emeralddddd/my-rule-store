...
shadowsocks={{ customParams.vpsServer }}:{{ customParams.vpsPort }}, method={{ customParams.vpsEncryptMethod }}, password={{ customParams.vpsPassword }}, udp-relay=true, tag={{ customParams.vpsName }}
socks5={{ customParams.ipRoyalServer }}:{{ customParams.ipRoyalPort }}, username={{ customParams.ipRoyalUsername }}, password={{ customParams.ipRoyalPassword }}, fast-open=false, udp-relay=true, tag={{ customParams.ipRoyalName }}
...
static=🤖 OpenAI, {{ customParams.ipRoyalName }},🚀 节点选择,🇺🇸 美国,🇭🇰 香港,🇯🇵 日本,🇸🇬 新加坡,🎯 全球直连, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/ChatGPT.png
static=🧠 Claude, {{ customParams.vpsName }},{{ customParams.ipRoyalName }},🚀 节点选择,🇺🇸 美国,🇭🇰 香港,🇯🇵 日本,🇸🇬 新加坡,🎯 全球直连, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/ChatGPT.png
...
static=🇭🇰 香港, 🇭🇰 Auto HK, {{ getNodeNames(nodeList, hkFilter) }},img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/HK.png
...
static=🇯🇵 日本, 🇯🇵 Auto JP, {{ getNodeNames(nodeList, japanFilter) }},img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/JP.png
...
[filter_local]
{{ remoteSnippets.unbreak.main('🔓 Unbreak') | quantumultx}}
{{ remoteSnippets.youtube.main('📺 YouTube') | quantumultx}}
{{ remoteSnippets.disney.main('🎬 Disney+') | quantumultx}}
{{ remoteSnippets.hbomax.main('🎬 HBO Max') | quantumultx}}
{{ remoteSnippets.netflix.main('🎬 Netflix') | quantumultx}}
{{ remoteSnippets.bahamut.main('🎬 Bahamut') | quantumultx}}
{{ remoteSnippets.bilibili.main('📺 Bilibili') | quantumultx}}
{{ remoteSnippets.spotify.main('🎵 Spotify') | quantumultx}}
{{ remoteSnippets.steam.main('🎮 Steam') | quantumultx}}
